...
BOOL GameEngine::CheckSpriteCollision(Sprite* pTestSprite)
{
  ...
  for (; siSprite != m_vSprites.end(); siSprite++)
  {
...
void GameEngine::PlayMIDISong(LPTSTR szMIDIFileName, BOOL bRestart)
{
  ...
  {
	  //szMIDIFileName=L"c:\\WELCOME.WAV";
  ...
  if (mciSendCommand(m_uiMIDIPlayerID, MCI_PLAY, MCI_DGV_PLAY_REPEAT,
